...
import SensingSystem.SensingSystem;
...
public class World implements ISteppable {
	...
	public World() {
		...
		//this.cars[1] = new Car(new Point2D.Double(150,140), 6, 10, Color.MAGENTA, 25f, 50f, 6f );

		this.controllers[0] = new KeyboardController(cars[0]);
		this.controllers[1] = new AIController(cars[0],new SensingSystem(this,cars[0]));
