...
public final class Intersection {
	...
	public void render(ShapeRenderer r){
		...
		r.rectLine((float)this.pos.x, (float)this.pos.y + INTERSECTION_LINE_WIDTH/2, 
				   (float)this.pos.x + width, (float)this.pos.y + INTERSECTION_LINE_WIDTH/2, //bottom
				   INTERSECTION_LINE_WIDTH);
																								//r.rect((float)this.pos.x,(float)this.pos.y,this.width,INTERSECTION_LINE_WIDTH);
		r.rectLine((float)this.pos.x + width - INTERSECTION_LINE_WIDTH/2, (float)this.pos.y, 
				   (float)this.pos.x + width -INTERSECTION_LINE_WIDTH/2, (float)this.pos.y+length,	//right
				   INTERSECTION_LINE_WIDTH);
																									//r.rect((float)this.pos.x+this.width-INTERSECTION_LINE_WIDTH,(float)this.pos.y,INTERSECTION_LINE_WIDTH,this.width);
		r.rectLine((float)this.pos.x + INTERSECTION_LINE_WIDTH/2, (float)this.pos.y,			//left
				   (float)this.pos.x + INTERSECTION_LINE_WIDTH/2, (float)this.pos.y + length, 
				   INTERSECTION_LINE_WIDTH);
																								//r.rect((float)this.pos.x,(float)this.pos.y,INTERSECTION_LINE_WIDTH,this.width);
		r.rectLine((float)this.pos.x, (float)this.pos.y+length - INTERSECTION_LINE_WIDTH/2, 
				   (float)this.pos.x + width, (float)this.pos.y + length - INTERSECTION_LINE_WIDTH/2, //top
				   INTERSECTION_LINE_WIDTH);
																									//r.rect((float)this.pos.x,(float)this.pos.y+this.length-INTERSECTION_LINE_WIDTH,this.width,INTERSECTION_LINE_WIDTH);
